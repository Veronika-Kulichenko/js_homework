...
let bar = new Bar("Blue oyster");

class Drink {
	constructor(drinkName, quantity){
...
class Barmen extends Employee {
	constructor(name, age, crownСocktail){
		super(name, age);
		this.crownСocktail = crownСocktail;
	}

	completeOrder(drinkName, quantity){ 
...
bar.addEmployee("Egor", 32, "barmen");
